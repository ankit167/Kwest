...
<form class="form-horizontal" role="form" style="margin-top: 30px;" method="post" action="Cat.htm">
    ...
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="username" placeholder="Your New Category" name="category_name">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="password" placeholder="Your New Category" name="category_desc">
    </div>
  </div>
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10" align="left">
      <button type="submit" class="btn btn-default" onclick="return checklogin()">Add Category</button>
    </div>
  </div>
