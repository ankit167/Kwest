...
<form:form action="show1.htm" method="post" commandName="question" class="form-horizontal" role="form" style="margin-top: 30px;">
<div class="form-group">
  <label class="control-label col-sm-3" for="cat">Select Question:</label>
   <div class="col-sm-9" style="padding-right:30px; margin-bottom:10px;"> 


<form:select path="question" items="${dlist}" class="col-sm-9" id="sel1"></form:select>
