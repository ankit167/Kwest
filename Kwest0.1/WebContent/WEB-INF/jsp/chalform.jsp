...
<!-- NAVIGATION MENU -->
	...
	<div class="navbar-nav navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<a class="navbar-brand" href="User_Console.html" style="padding:0;padding-top:15px;width:200px;">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="Challenge.htm"><i class="icon-lock icon-white"></i>Challenge</a></li>
...
<form:form action="startchallenge1.htm" commandName="user" class="form-horizontal" role="form" style="margin-top: 30px;">
<div class="form-group">
  <label class="control-label col-sm-3" for="cat">Select User:</label>
   <div class="col-sm-9" style="padding-right:30px; margin-bottom:10px;"> 



<form:select action="" path="username" items="${elist}" class="col-sm-9" id="sel1"></form:select>
