		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="ViewScoreboard.htm"><i class="icon-user icon-white"></i>View Leaderboard</a></li>
...
<div class="container"  align="center" >
	<div class="panel panel-default" style="margin-top: 100px;width: 800px; ">
      <div class="panel-heading">Visit Soon</div>
    



<form:form action="quiz.htm" commandName="category" class="form-horizontal" role="form" style="margin-top: 30px;">
<div class="form-group">
  
   <div class="col-sm-9" style="padding-right:30px; margin-bottom:10px;"> 


<h2>Sorry Buddy!!! No categories added yet. </h2>
